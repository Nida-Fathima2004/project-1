...
# ================================
st.markdown("<hr style='margin:40px 0;'><h3 style='text-align:center; color:#1e3c72;'>Project Guides</h3>", unsafe_allow_html=True)
...
keerthana= get_image_base64("WhatsApp Image 2025-10-08 at 4.36.32 PM1.jpeg")
